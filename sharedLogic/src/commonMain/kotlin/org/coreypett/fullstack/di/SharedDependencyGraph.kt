...
object SharedDependencyGraph {
    ...
    fun recentTradesRepository(): RecentTradesRepository = ensureKoin().get()
    ...
    fun recentTradesFeature(): RecentTradesFeature = ensureKoin().get()
...
private val serviceModule = module {
    ...
    single<RecentTradesService> {
        RecentTradesService.Impl(
            webSocketClient = get(),
            json = get(),
        )
    }
...
private val repositoryModule = module {
    ...
    single<RecentTradesRepository> { RecentTradesRepository.Impl(service = get()) }
}
...
private val presentationModule = module {
    ...
    factory { RecentTradesFeature(repository = get()) }
}
